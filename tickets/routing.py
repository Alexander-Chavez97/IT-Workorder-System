...
# Department list sourced from City of Laredo IST ticket history (FY 2024-2026).
DEPARTMENT_TIERS: dict[str, str] = {
    # Critical Infrastructure
    "Fire Department":                          DeptTier.CRITICAL_INFRA,
    "Fire Department - Administration":         DeptTier.CRITICAL_INFRA,
    "Fire Department - Prevention":             DeptTier.CRITICAL_INFRA,
    "Police Department":                        DeptTier.CRITICAL_INFRA,
    "Police - Administration":                  DeptTier.CRITICAL_INFRA,
    "Police - Criminal Intelligence":           DeptTier.CRITICAL_INFRA,
    "Police - Detective":                       DeptTier.CRITICAL_INFRA,
    "Police - Patrol":                          DeptTier.CRITICAL_INFRA,
    "Airport - Police":                         DeptTier.CRITICAL_INFRA,
    "Utilities Department":                     DeptTier.CRITICAL_INFRA,
    "Utilities - Administration":               DeptTier.CRITICAL_INFRA,
    "Utilities - Billing":                      DeptTier.CRITICAL_INFRA,
    "Utilities - Engineering":                  DeptTier.CRITICAL_INFRA,
    "Utilities - GIS":                          DeptTier.CRITICAL_INFRA,
    "Utilities - South Waste Water":            DeptTier.CRITICAL_INFRA,
    "Utilities - Waste Water Collection":       DeptTier.CRITICAL_INFRA,
    "Utilities - Wastewater Treatment Plant":   DeptTier.CRITICAL_INFRA,
    "Utilities - Water Distribution":           DeptTier.CRITICAL_INFRA,
    "Utilities - Water Pollution Control":      DeptTier.CRITICAL_INFRA,
    "Bridge System - Bridge I":                 DeptTier.CRITICAL_INFRA,
    "Bridge System - Bridge II":                DeptTier.CRITICAL_INFRA,
    "Bridge System - World Trade Bridge":       DeptTier.CRITICAL_INFRA,
    "Traffic Safety":                           DeptTier.CRITICAL_INFRA,
    "Traffic Safety - Parking Enforcement":     DeptTier.CRITICAL_INFRA,
    "Transit System - Administration":          DeptTier.CRITICAL_INFRA,
    "Transit System - El Metro":                DeptTier.CRITICAL_INFRA,
    # Executive
    "City Manager":                             DeptTier.EXECUTIVE,
    "City Manager - Council Support":           DeptTier.EXECUTIVE,
    "City Manager - Internal Audit":            DeptTier.EXECUTIVE,
    "City Manager - Public Access":             DeptTier.EXECUTIVE,
    "City Secretary":                           DeptTier.EXECUTIVE,
    "City Attorney":                            DeptTier.EXECUTIVE,
    "Internal Audit":                           DeptTier.EXECUTIVE,
    "Budget":                                   DeptTier.EXECUTIVE,
    "Public Information Office":                DeptTier.EXECUTIVE,
    # Public Safety
    "Health Department":                        DeptTier.PUBLIC_SAFETY,
    "Health - Ambulance / EMS":                 DeptTier.PUBLIC_SAFETY,
    "Health - Bioterrorism":                    DeptTier.PUBLIC_SAFETY,
    "Health - Environmental Health":            DeptTier.PUBLIC_SAFETY,
    "Health - Epidemiology":                    DeptTier.PUBLIC_SAFETY,
    "Health - HIV Prevention":                  DeptTier.PUBLIC_SAFETY,
    "Health - Immunization":                    DeptTier.PUBLIC_SAFETY,
    "Health - Laboratory":                      DeptTier.PUBLIC_SAFETY,
    "Health - Nurse Family Partners":           DeptTier.PUBLIC_SAFETY,
    "Health - Patient Care Services":           DeptTier.PUBLIC_SAFETY,
    "Health - Pharmacy":                        DeptTier.PUBLIC_SAFETY,
    "Health - TB":                              DeptTier.PUBLIC_SAFETY,
    "Health - Vital Statistics":                DeptTier.PUBLIC_SAFETY,
    "Health - W.I.C.":                          DeptTier.PUBLIC_SAFETY,
    "Detoxification Department":                DeptTier.PUBLIC_SAFETY,
    "Laredo Animal Care Services":              DeptTier.PUBLIC_SAFETY,
    # Standard
    "Administrative Services":                  DeptTier.STANDARD,
    "Airport - Administration":                 DeptTier.STANDARD,
    "Airport - FIS":                            DeptTier.STANDARD,
    "Airport - Ground Maintenance":             DeptTier.STANDARD,
    "Building Development Services":            DeptTier.STANDARD,
    "Community Development - Administration":   DeptTier.STANDARD,
    "Community Development - Code Enforcement": DeptTier.STANDARD,
    "Community Development - Housing":          DeptTier.STANDARD,
    "Community Development - Municipal Housing":DeptTier.STANDARD,
    "Community Development - Real Estate":      DeptTier.STANDARD,
    "Convention & Visitors Bureau":             DeptTier.STANDARD,
    "Economic Development":                     DeptTier.STANDARD,
    "Engineering - Construction Inspection":    DeptTier.STANDARD,
    "Engineering - Design & Surveying":         DeptTier.STANDARD,
    "Engineering - Solid Waste":                DeptTier.STANDARD,
    "Environmental Services":                   DeptTier.STANDARD,
    "Finance - Accounting":                     DeptTier.STANDARD,
    "Finance - Accounts Payable":               DeptTier.STANDARD,
    "Finance - Payroll":                        DeptTier.STANDARD,
    "Finance - Purchasing":                     DeptTier.STANDARD,
    "Fleet Management":                         DeptTier.STANDARD,
    "Human Resources":                          DeptTier.STANDARD,
    "Human Resources - Administration":         DeptTier.STANDARD,
    "Human Resources - Civil Service":          DeptTier.STANDARD,
    "Human Resources - Employee Health":        DeptTier.STANDARD,
    "Human Resources - Fire & Police":          DeptTier.STANDARD,
    "Human Resources - Risk Management":        DeptTier.STANDARD,
    "Human Resources - Training":               DeptTier.STANDARD,
    "Information Services & Technology":        DeptTier.STANDARD,
    "IST - Cybersecurity":                      DeptTier.STANDARD,
    "IST - Support Services Division":          DeptTier.STANDARD,
    "Library - Main Branch":                    DeptTier.STANDARD,
    "Library - Bruni Plaza Branch":             DeptTier.STANDARD,
    "Library - Inner City Branch":              DeptTier.STANDARD,
    "Library - MOS":                            DeptTier.STANDARD,
    "Municipal Court":                          DeptTier.STANDARD,
    "Parks & Leisure - Administration":         DeptTier.STANDARD,
    "Parks & Leisure - Aquatics":               DeptTier.STANDARD,
    "Parks & Leisure - Cemetery":               DeptTier.STANDARD,
    "Parks & Leisure - Cigarroa Recreation":    DeptTier.STANDARD,
    "Parks & Leisure - El Eden":                DeptTier.STANDARD,
    "Parks & Leisure - Fasken NW Recreation":   DeptTier.STANDARD,
    "Parks & Leisure - Hachar Recreation":      DeptTier.STANDARD,
    "Parks & Leisure - Haynes Recreation":      DeptTier.STANDARD,
    "Parks & Leisure - Inner City Recreation":  DeptTier.STANDARD,
    "Parks & Leisure - NE Hillside Recreation": DeptTier.STANDARD,
    "Planning Department":                      DeptTier.STANDARD,
    "Public Works":                             DeptTier.STANDARD,
    "Public Works - Cemetery":                  DeptTier.STANDARD,
    "Solid Waste":                              DeptTier.STANDARD,
    "Solid Waste - Landfill":                   DeptTier.STANDARD,
    "Tax Department":                           DeptTier.STANDARD,
}
...
DEPARTMENT_CHOICES = [
    ...
    ("City Manager - Council Support",                "City Manager - Council Support"),
    ("City Manager - Internal Audit",                 "City Manager - Internal Audit"),
    ("City Manager - Public Access",                  "City Manager - Public Access"),
    ...
    ("Airport - FIS",                                 "Airport - FIS"),
    ("Airport - Ground Maintenance",                  "Airport - Ground Maintenance"),
    ("Airport - Police",                              "Airport - Police"),
    # Bridge System
    ("Bridge System - Bridge I",                      "Bridge System - Bridge I"),
    ("Bridge System - Bridge II",                     "Bridge System - Bridge II"),
    ("Bridge System - World Trade Bridge",            "Bridge System - World Trade Bridge"),
    # Building
    ("Building Development Services",                 "Building Development Services"),
    # Community Development
    ("Community Development - Administration",        "Community Development - Administration"),
    ("Community Development - Code Enforcement",      "Community Development - Code Enforcement"),
    ("Community Development - Housing",               "Community Development - Housing"),
    ("Community Development - Municipal Housing",     "Community Development - Municipal Housing"),
    ("Community Development - Real Estate",           "Community Development - Real Estate"),
    # Convention
    ("Convention & Visitors Bureau",                  "Convention & Visitors Bureau"),
    # Detoxification
    ("Detoxification Department",                     "Detoxification Department"),
    # Economic Development
    ("Economic Development",                          "Economic Development"),
    # Engineering
    ("Engineering - Construction Inspection",         "Engineering - Construction Inspection"),
    ("Engineering - Design & Surveying",              "Engineering - Design & Surveying"),
    ("Engineering - Solid Waste",                     "Engineering - Solid Waste"),
    # Environmental
    ("Environmental Services",                        "Environmental Services"),
    # Finance
    ("Finance - Accounting",                          "Finance - Accounting"),
    ("Finance - Accounts Payable",                    "Finance - Accounts Payable"),
    ("Finance - Payroll",                             "Finance - Payroll"),
    ("Finance - Purchasing",                          "Finance - Purchasing"),
    # Fire
    ("Fire Department",                               "Fire Department"),
    ("Fire Department - Administration",              "Fire Department - Administration"),
    ("Fire Department - Prevention",                  "Fire Department - Prevention"),
    # Fleet
    ("Fleet Management",                              "Fleet Management"),
    # Health
    ("Health Department",                             "Health Department"),
    ("Health - Ambulance / EMS",                      "Health - Ambulance / EMS"),
    ("Health - Bioterrorism",                         "Health - Bioterrorism"),
    ("Health - Environmental Health",                 "Health - Environmental Health"),
    ("Health - Epidemiology",                         "Health - Epidemiology"),
    ("Health - HIV Prevention",                       "Health - HIV Prevention"),
    ("Health - Immunization",                         "Health - Immunization"),
    ("Health - Laboratory",                           "Health - Laboratory"),
    ("Health - Nurse Family Partners",                "Health - Nurse Family Partners"),
    ("Health - Patient Care Services",                "Health - Patient Care Services"),
    ("Health - Pharmacy",                             "Health - Pharmacy"),
    ("Health - TB",                                   "Health - TB"),
    ("Health - Vital Statistics",                     "Health - Vital Statistics"),
    ("Health - W.I.C.",                               "Health - W.I.C."),
    # Human Resources
    ("Human Resources",                               "Human Resources"),
    ("Human Resources - Administration",              "Human Resources - Administration"),
    ("Human Resources - Civil Service",               "Human Resources - Civil Service"),
    ("Human Resources - Employee Health",             "Human Resources - Employee Health"),
    ("Human Resources - Fire & Police",               "Human Resources - Fire & Police"),
    ...
    ("IST - Cybersecurity",                           "IST - Cybersecurity"),
    ("IST - Support Services Division",               "IST - Support Services Division"),
    # Animal Care
    ("Laredo Animal Care Services",                   "Laredo Animal Care Services"),
    # Library
    ("Library - Main Branch",                         "Library - Main Branch"),
    ("Library - Bruni Plaza Branch",                  "Library - Bruni Plaza Branch"),
    ("Library - Inner City Branch",                   "Library - Inner City Branch"),
    ("Library - MOS",                                 "Library - MOS"),
    # Municipal Court
    ("Municipal Court",                               "Municipal Court"),
    # Parks & Leisure
    ("Parks & Leisure - Administration",              "Parks & Leisure - Administration"),
    ("Parks & Leisure - Aquatics",                    "Parks & Leisure - Aquatics"),
    ("Parks & Leisure - Cemetery",                    "Parks & Leisure - Cemetery"),
    ("Parks & Leisure - Cigarroa Recreation",         "Parks & Leisure - Cigarroa Recreation"),
    ("Parks & Leisure - El Eden",                     "Parks & Leisure - El Eden"),
    ("Parks & Leisure - Fasken NW Recreation",        "Parks & Leisure - Fasken NW Recreation"),
    ("Parks & Leisure - Hachar Recreation",           "Parks & Leisure - Hachar Recreation"),
    ("Parks & Leisure - Haynes Recreation",           "Parks & Leisure - Haynes Recreation"),
    ("Parks & Leisure - Inner City Recreation",       "Parks & Leisure - Inner City Recreation"),
    ("Parks & Leisure - NE Hillside Recreation",      "Parks & Leisure - NE Hillside Recreation"),
    # Planning
    ("Planning Department",                           "Planning Department"),
    # Police
    ("Police Department",                             "Police Department"),
    ("Police - Administration",                       "Police - Administration"),
    ("Police - Criminal Intelligence",                "Police - Criminal Intelligence"),
    ("Police - Detective",                            "Police - Detective"),
    ("Police - Patrol",                               "Police - Patrol"),
    # Public Works
    ("Public Works",                                  "Public Works"),
    ("Public Works - Cemetery",                       "Public Works - Cemetery"),
    # Solid Waste
    ...
    ("Traffic Safety - Parking Enforcement",          "Traffic Safety - Parking Enforcement"),
    ("Transit System - Administration",               "Transit System - Administration"),
    ("Transit System - El Metro",                     "Transit System - El Metro"),
    # Utilities
    ("Utilities Department",                          "Utilities Department"),
    ("Utilities - Administration",                    "Utilities - Administration"),
    ("Utilities - Billing",                           "Utilities - Billing"),
    ("Utilities - Engineering",                       "Utilities - Engineering"),
    ("Utilities - GIS",                               "Utilities - GIS"),
    ("Utilities - South Waste Water",                 "Utilities - South Waste Water"),
    ("Utilities - Waste Water Collection",            "Utilities - Waste Water Collection"),
    ("Utilities - Wastewater Treatment Plant",        "Utilities - Wastewater Treatment Plant"),
    ("Utilities - Water Distribution",                "Utilities - Water Distribution"),
    ("Utilities - Water Pollution Control",           "Utilities - Water Pollution Control"),
]
CATEGORY_CHOICES = [
