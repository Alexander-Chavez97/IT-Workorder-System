# Generated migration for tickets app
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_priority', models.IntegerField(
                    choices=[(4, 'Low — Minor issue, no work stoppage'), (3, 'Medium — Workaround exists, productivity affected'), (2, 'High — Work is halted, team affected'), (1, 'Critical — System down, department or city-wide')],
                    default=4,
                    verbose_name='User-Selected Priority',
                )),
